...
{
public:
    RedTargets(efylw5Engine* ptrEngine, Timer* timer, int iMapX, int iMapY, int color, int difficulty, int shape);
    ~RedTargets(void);
...
private:
    ...
    MovementPosition mp;
    bool bounceUp, bounceDown, pointLock, hit, drawn;
    Timer* timer;
